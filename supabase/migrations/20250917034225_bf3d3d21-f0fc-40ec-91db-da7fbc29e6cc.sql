-- PHASE 1: Complete data reset and new test data (FIXED with correct enums)
...
-- Ensure we have the 4 real locations with correct enum values
DELETE FROM locations;
INSERT INTO locations (id, name, code, type, address, is_active) VALUES
(gen_random_uuid(), 'Bodega Central', 'BC001', 'oficina', 'Bodega principal de almacenamiento', true),
(gen_random_uuid(), 'POS-Colina', 'PC001', 'punto_venta', 'Punto de venta Colina', true),
(gen_random_uuid(), 'POS-Fontanar', 'PF001', 'punto_venta', 'Punto de venta Fontanar', true),
(gen_random_uuid(), 'POS-Eventos', 'PE001', 'punto_venta', 'Punto de venta Eventos', true);
...
-- Insert 5 bulk gum products (using correct enum value)
...
(gen_random_uuid(), 'Gomas Rojas al Granel', 'GRG001', 'goma_granel', 'gomas_granel', 1000, 180, 1, 50, 100, 5.50, true),
(gen_random_uuid(), 'Gomas Verdes al Granel', 'GVG002', 'goma_granel', 'gomas_granel', 1000, 180, 1, 50, 100, 5.50, true),
(gen_random_uuid(), 'Gomas Amarillas al Granel', 'GAG003', 'goma_granel', 'gomas_granel', 1000, 180, 1, 50, 100, 5.50, true),
(gen_random_uuid(), 'Gomas Azules al Granel', 'GBG004', 'goma_granel', 'gomas_granel', 1000, 180, 1, 50, 100, 5.50, true),
(gen_random_uuid(), 'Gomas Mixtas al Granel', 'GMG005', 'goma_granel', 'gomas_granel', 1000, 180, 1, 50, 100, 5.50, true);
