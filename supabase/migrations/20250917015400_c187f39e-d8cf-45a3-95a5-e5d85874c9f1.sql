-- FASE 1: MIGRACIÓN CRÍTICA CORREGIDA - ESTRUCTURA DE BASE DE DATOS
...
-- Limpiar ubicaciones existentes y crear las 4 específicas
DELETE FROM public.locations WHERE code NOT IN ('bodega-central', 'pos-colina', 'pos-fontanar', 'pos-eventos');

-- Insertar/actualizar ubicaciones específicas
